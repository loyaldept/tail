...
export default function WhyWritingMatterPage() {
  ...
  const essayContent = `I never had great writing skills. My handwriting was awful, and writing essays always felt like a struggle. I couldn't understand long academic papers, sometimes 12 pages filled with complex words and confusing structure. In college, many students now use tools like Large Language Models (LLMs) to generate these kinds of papers.
    ...
    <div className="min-h-screen bg-background font-mono">
      ...
      <div className="max-w-3xl mx-auto p-6 lg:p-12">
        ...
        <article className="prose prose-lg max-w-none">
          <div className="mb-8">
            <h1 className="text-3xl lg:text-4xl font-bold mb-4">Why Do We Write?</h1>
            <p className="text-muted-foreground">4 min read</p>
          </div>

          <div className="space-y-6 text-base lg:text-lg leading-relaxed whitespace-pre-line">{essayContent}</div>
        </article>
      </div>
    </div>
  )
